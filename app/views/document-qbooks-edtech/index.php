...
<body>
  ...
  <header class="header">
    ...
    <div class="header-title-bar">
      <span>Trung tâm Tài liệu Dự án QBooks EdTech - Bảo mật cao</span>
    </div>
    ...
    <aside class="sidebar">
      <div>
        ...
        <div class="flow-steps">
          <div class="step-item active" data-doc="qna" id="step-qna">
            <div class="step-badge">1</div>
            <div class="step-content">
              <span class="step-title">01. QnA</span>
  ...
  <script>
    (function() {
      ...
      function reportViolation(reason) {
        ...
        // Report to server
        fetch('/api/v1/document-qbooks-edtech/report-violation', {
          method: 'POST',
          headers: {
